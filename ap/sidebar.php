			...
			<!--/down-->
							<div class="down">	
									 ...
									 <p> Administrator</p>
									<ul>
									<li><a class="tooltips" href="profile.php"><span>Profile</span><i class="fa fa-users"></i></a></li>
										</ul>
									</div>
							   <!--//down-->
                           <div class="menu">
									...
									<li id="menu-academico" ><a href="donor.php"><i class="fa fa-users"></i> <span>Donor</span> <span class="fa fa-angle-right" style="float: right"></span></a>
										 </li>
									
									 <li id="menu-academico" ><a href="ngo.php"><i class="fa fa-wheelchair"></i> <span>NGO</span> <span class="fa fa-angle-right" style="float: right"></span></a> 
									 </li>
