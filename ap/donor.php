...
<body>
   ...
   <!--/content-inner-->
							...
							<div class="outter-wp">
								  ...
								  <!--//sub-heard-part-->
									<div class="graph-visual tables-main">
												...
												<h3 class="inner-tittle two">Registered Donor </h3>
													<a href="Reports/donorreport.php">Generate Report</a><br><br>
													<div class="graph">
														<div class="tables">
	...
	$result=mysqli_query($conn,$sql);
	 ...
	 {
		 echo "<tr>";
		  echo "<td><input name='chkbox[]' type='checkbox' value=$row[donor_id]></td>";
...
if(isset($_POST['delete']))
{
	...
	for($i=0;$i<$cnt;$i++)
	{
		...
		$query="delete from donor where donor_id=".$del_id;
		mysqli_query($conn,$query);
		echo "		<script>
						alert('Record Deleted !');
						window.location='../ap/donor.php';
					</script>";
