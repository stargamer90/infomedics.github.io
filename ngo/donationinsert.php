...
if (isset($_POST['submit']))
{
    ...
    $donor_id  = $_POST['donor_id'];
     ...
     $query = "INSERT INTO donation (amount,donor_id) VALUES 
	 ('$amount', '$donor_id')";
													...
													<div class="forms-main">
																			 ...
																			 <div class="set-3">
																				<div class="graph-2 general">
																					<h3 class="inner-tittle two">New Donation Form </h3>
																						<div class="grid-1">
																						<form class="form-horizontal">
																									<div class="form-group">
																										<label class="col-md-2 control-label">Donation Amount</label>
																										<div class="col-md-8">
																											<div class="input-group">							
																												<span class="input-group-addon">
																													<i class="fa fa-users"></i>
																												</span>
																												<input type="text" name="amount" class="form-control1 icon" placeholder="Name" required>
																											</div>
																										</div>
																									</div>
																									<br><br>																						
