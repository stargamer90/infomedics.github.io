...
if ($_SERVER["REQUEST_METHOD"] == "POST")
	{
		...
		if( $image_path!='' )
			{
				//echo "value not null";
				$sql ="update gallery set image_path='".$image_path."'
				where gallery_id = '".$id."' ";
   ...
   if(isset($_FILES['image'])){
      ...
      */
      if(empty($errors)==true)
	  {
		 ...
		 {
			 $query="INSERT INTO gallery(image_path) values('".$file_name."')";
				echo "Success";
													...
													<div class="forms-main">
																			 ...
																			 <div class="set-3">
																				<div class="graph-2 general">
																					<h3 class="inner-tittle two">Update Gallery Form </h3>
																						<div class="grid-1">
																									...
																									<div class="form-group">
																										...
																										<div class="col-md-8">
																											<div class="input-group">
																												...
																												<input type="file" name="image_path" class="form-control1 icon" id="exampleInputRegistrationid"  required>
																											</div>
																										</div>
																									</div>
																									<br><br>
