...
if (isset($_POST['submit']))
{
	...
	$ngo_id  = $_POST['ngo_id'];
     ...
     $query = "INSERT INTO feedback(feedback,donor_id,ngo_id) VALUES 
	 ('$feedback', '$donor_id', '$ngo_id')";
													...
													<div class="forms-main">
																			 ...
																			 <div class="set-3">
																				<div class="graph-2 general">
																					<h3 class="inner-tittle two">Feedback</h3>
																						<div class="grid-1">
																									...
																									<div class="form-group">
																										...
																										<div class="col-md-8">
																											<div class="input-group">							
																												...
																												<input type="text" name="feedback" class="form-control1 icon" placeholder="" required>
																											</div>
																										</div>
																									</div>
																									<br><br>																						
