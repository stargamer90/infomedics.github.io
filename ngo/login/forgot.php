...
require_once("C:\xampp\htdocs\welfare_foundation\ngo\lib\function.php");
include('C:\xampp\htdocs\welfare_foundation\PHPMailer\PHPMailerAutoload.php');
if ($_SERVER["REQUEST_METHOD"]=="POST") {
	...
	if(isset($_POST['username']) && !empty($_POST['username']))
	{
		...
		$query = "select * from ngo where ngo_emailid = '".$username."'";
		...
		if (mysqli_num_rows($result) == 1) {
			...
			$query1 = "update ngo set otp = ".$otp.", otp_used = 0 where 
			ngo_emailid = '".$to."'";
