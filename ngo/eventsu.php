...
if ($_SERVER["REQUEST_METHOD"] == "POST")
	{
		if (isset($_POST["eventname"]) && isset($_POST["eventdes"]) && isset($_POST["venue"]) &&  isset($_POST["donor_id"]) && isset($_POST["area_id"]) )
		{ 
			echo "value set";
		...
		if($eventname!='' && $eventdes!='' && $venue!=''&& $donor_id!=''  && $area_id!='' )
			{
				echo "value not null";
				$sql ="update events set event_name='".$eventname."',area_id='".$area_id."',
				event_description='".$eventdes."',venue='".$venue."',donor_id='".$donor_id."',area_id='".$area_id."'
				  where event_id=$id";
																									...
																									<div class="form-group">
																										...
																										<div class="col-md-8">
																											<div class="input-group">
																												...
																												<input type="password" name="venue" class="form-control1 icon" id="exampleInputPassword1" value=<?php echo $row['venue']?> >
																											</div>
																										</div>
																									</div>
																									<br><br>
