...
<body>
   ...
   <!--/content-inner-->
	<div class="left-content">
								  ...
								  <!--//sub-heard-part-->
									<div class="graph-visual tables-main">
											...
											<form method="post">
												...
												<h3 class="inner-tittle two">Donation Details </h3>
												<div class="sub-heard-part">
												<ol class="breadcrumb m-b-0">
												
												<li><a href="Reports/donationreport.php">Generate Report</a></li>
												</ol>
												</div>
													<div class="graph">
														<div class="tables">
	 ...
	 $sql="Select d1.donation_id ,d1.amount,d1.donation_date
	,n.donor_firstname from donation d1 join donor n 
	where d1.donor_id = n.donor_id";
