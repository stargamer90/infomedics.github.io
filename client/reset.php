...
if ($_SERVER["REQUEST_METHOD"]=="POST") {
	...
	$query = "update donor set otp_used = 1, 
	donor_password = '".$nPass."' where  
	otp = '".$otp."' ";
	//echo $query;
	//die;
		...
		<div class="login-form">
			<div class="sign-in-htm">
				<div class="group">
					...
					<input id="email" name="otp" type="text" class="input" required>
				</div>
				<div class="group">
					<label for="user" class="label">Password</label>
					<input id="npass" name="newpassword" type="password" class="input" required>
				</div>
				<div class="group">
					<label for="user" class="label">Confirm Password</label>
					<input id="cpassword" name="cpassword" type="password" class="input" required>
				</div>
				<div class="group">
						<a href="index.php"></a>
