...
<!-- Mirrored from iglyphic.com/themes/html/html_elevation/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 15 Dec 2018 09:29:07 GMT -->
<head>
    <meta charset="utf-8">
...
<body>
    ...
    <div class="about-body">
        <div class="container">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="image-box two-column">
                        <div class="image">
                            <img src="images/about/1.jpg" alt="charity" />
                        </div>
                        <div class="text">
                            <h3><a href="#">Mission</a></h3>
                            <p>
                                Vision is our mission. Restoring vision to people in developing nations is our cause. We are a non-profit organization with a focus on empowering local phy sicians and creating a sustainable solution to the blindness epidemic. partnerships helps us remain efficient.
                            </p>
                        </div>
                    </div><!--/.image-box-->
                </div>
                <div class="col-sm-6">
                    <div class="image-box two-column">
                        <div class="image">
                            <img src="images/about/2.jpg" alt="charity" />
                        </div>
                        <div class="text">
                            <h3><a href="#">Vision</a></h3>
                            <p>
                                We've learned how to stretch every donation. Many fine companies donate used and new equipment and supplies to our cause. Countless people donate their time and talents. Keeping overhead low and building smart partnerships helps us remain efficient.
                            </p>
                        </div>
                    </div><!--/.image-box-->
                </div>
    ...
    <!-- == Video Section == -->
    <section class="video-section mt80 green-card">
        <div class="video-box">
            <div class="iamge">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="section-heading text-center section-padding mb50">
                        <h2>Our Team</h2>
                        <span>You Can Help Lots Of People By Donating Little.</span>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4 col-sm-4">
                    <div class="team-member">
                        <div class="image">
                            <img src="images/about/3.jpg" class="img-responsive" alt="">
                        </div>
                        <div class="social-media green-bg">
                            <ul>
    ...
    <!-- == Testimonial == -->
    <section class="testimonial-area mt70 pdb80">
                    ...
                    <div class="col-lg-8 col-md-8 mt85 col-sm-7">
                       ...
                       <div class="carousel-inner ">
                           <div class="item active">
                               <div class="quote">
                                   I understand the difficulties that people at there faced. In order to <strong>contribute to resolve</strong> this problems, our nonprofit organization usually part in <strong>charity events</strong> and activities.
                               </div>
                           ...
                           <div class="item">
                               <div class="quote">
                                   Our nonprofit organization usually I understand the difficulties that people at there faced. In order to <strong>contribute to resolve</strong> this problems, part in <strong>charity events</strong> and activities.
                               </div>
                               <p>Bacon questioned the Aristotelian concepts of formal cause and final cause, and promoted the idea that science should study the laws of "simple" natures, such as heat, rather than assuming</p>
                           </div>
                           <!-- End Item -->
                        ...
                        <ul class="testimonial-carousel-control-nav pdt100">
                            <li data-target="#testimonial-carousel" data-slide-to="0" class="active">
                                <a href="#" data-toggle="tab">
                                    <img src="images/home/11.jpg" class="img-responsive" alt="client thumb" /><span>Mark Russhel  -  CEO at CTOA Inc.</span>
                                </a>
                            </li>
                            <li data-target="#testimonial-carousel" data-slide-to="1">
                                <a href="#" data-toggle="tab">
                                    <img src="images/home/12.jpg" class="img-responsive" alt="client thumb" /><span>Mark Russhel  -  CEO at CTOA Inc.</span>
                                </a>
                            </li>
                            <li data-target="#testimonial-carousel" data-slide-to="2">
                                <a href="#" data-toggle="tab">
                                    <img src="images/home/13.jpg" class="img-responsive" alt="client thumb" /><span>Mark Russhel  -  CEO at CTOA Inc.</span>
                                </a>
                            </li>
                            <li data-target="#testimonial-carousel" data-slide-to="3">
                                <a href="#" data-toggle="tab">
                                    <img src="images/home/14.jpg" class="img-responsive" alt="client thumb" /><span>Mark Russhel  -  CEO at CTOA Inc.</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="row row-eq-tab">
                    <div class="col-md-4 col-xs-12">
                        <div class="single map">
                            <a href="#"><img src="images/footer/1.png" alt="footer logo" /></a>
                            <div class="map-bg">
                                <p>
...
<!-- Mirrored from iglyphic.com/themes/html/html_elevation/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 15 Dec 2018 09:30:14 GMT -->
</html>
