...
<head>
    ...
    <title>Welfare Foundation || Home </title>
   ...
   <!-- Slider Section -->
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 slider-content">
                                <div class="slider-content-inner">
                                    ...
                                    <div class="slider-button delay4">
                                        <a href="login.php" class="green-button button-hover-one">Donate Now <i class="fa fa-heart" aria-hidden="true"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-12 col-xs-12 slider-content">
                                <div class="slider-content-inner">
                                    ...
                                    <p class="delay3">Continually redefine team building products rather than theme parallel world a class growth strategies for awesoem.</p>
                                    <div class="slider-button delay4">
                                        <a href="login/login.php" class="green-button button-hover-one">Donate Now <i class="fa fa-heart" aria-hidden="true"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="become-volienter pdb80">
                        <div class="text">
                            ...
                            <p>
								   ...
								   For charity or any event information donor needs to be registered. The Donor can donate and contact to the owner. 
                                </p>
                        </div>
                        <a class="green-button button-hover-one" href="login/login.php">Sign up today</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- == Image box == -->
        <div class="container">
            ...
            <div class="row">
			<?php
	$sql="select n.ngo_id , n.ngo_name,n.ngo_description,n.ngo_address1,n.ngo_address2,n.ngo_contact,n.ngo_password,n.ngo_emailid,n.registration_id
	,a.area_name,g.gallery_id , g.image_path from ngo n join area a join gallery g
	where n.area_id = a.area_id && g.ngo_id = n.ngo_id ";
